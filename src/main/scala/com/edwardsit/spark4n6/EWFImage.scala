...
object EWFImage {
  ...
  def createTableIfNecessary() {
    ...
    if (!admin.isTableAvailable(tableNameDefault)) {
      ...
      tableDesc.setMaxFileSize(4L * 1024L * 1024L * 1024L)
      admin.createTable(tableDesc, Array(
        "1000000000000000000000000000000000000000".getBytes,
        "2000000000000000000000000000000000000000".getBytes,
        "3000000000000000000000000000000000000000".getBytes,
        "4000000000000000000000000000000000000000".getBytes,
        "5000000000000000000000000000000000000000".getBytes,
        "6000000000000000000000000000000000000000".getBytes,
        "7000000000000000000000000000000000000000".getBytes,
        "8000000000000000000000000000000000000000".getBytes,
        "9000000000000000000000000000000000000000".getBytes,
        "a000000000000000000000000000000000000000".getBytes,
        "b000000000000000000000000000000000000000".getBytes,
        "c000000000000000000000000000000000000000".getBytes,
        "d000000000000000000000000000000000000000".getBytes,
        "e000000000000000000000000000000000000000".getBytes,
        "f000000000000000000000000000000000000000".getBytes
      ))
    }
