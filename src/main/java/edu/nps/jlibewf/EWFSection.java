...
public class EWFSection {
  ...
  public static final class SectionType {
     ...
     * @throws java.io.IOException if the requested section type is not a valid section type
     */
...
//    private static final int SECTION_ADLER32_OFFSET = 72;
     ...
     * @throws java.io.IOException If an I/O error occurs, which is possible if the read fails
     * or if the Adler32 checksum validation fails
     */
    public SectionPrefix(EWFSegmentFileReader reader, Path file, long fileOffset,
